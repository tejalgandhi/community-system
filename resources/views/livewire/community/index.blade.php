                                ...
                                <ul class="list-inline">
                                    ...
                                    <li class="pull-right">
                                        @if($popular_question->is_favorite == \App\Models\Question::FAVORITE)
                                            <a href="javascript:;" wire:click="changeFavorite({{$popular_question->id}})" class="text-yellow-600 hover:text-yellow-900">
                                                                                                               <i class="fa fa-star"></i></a>
                                        @else
                                            <a href="javascript:;" wire:click="changeFavorite({{$popular_question->id}},'1')" class="text-yellow-600 hover:text-yellow-900">
                                                <i class="fa fa-star-o"></i>
                                                            </a>
                                        @endif
                                        <a href="{{route('user.community.edit',$popular_question->id)}}" class="link-black text-sm"><i class="fa fa-edit"></i></a>
                                        <a href="#" class="link-black text-sm"><i class="fa fa-comments-o margin-r-5"></i>{{count($popular_question->answers)}}</a>
                                    </li>
                                </ul>
                                ...
                                <ul class="list-inline">
                                    ...
                                    <li class="pull-right">
                                      @if($new_question->is_favorite == \App\Models\Question::FAVORITE)
                                            <a href="javascript:;" wire:click="changeFavorite({{$new_question->id}})" class="text-yellow-600 hover:text-yellow-900">
                                                                                                               <i class="fa fa-star"></i></a>
                                        @else
                                            <a href="javascript:;" wire:click="changeFavorite({{$new_question->id}},'1')" class="text-yellow-600 hover:text-yellow-900">
                                                <i class="fa fa-star-o"></i>
                                                            </a>
                                        @endif
                                        <a href="{{route('user.community.edit',$new_question->id)}}" class="link-black text-sm"><i class="fa fa-edit"></i></a>
                                        <a href="#" class="link-black text-sm"><i class="fa fa-comments-o margin-r-5"></i>{{count($new_question->answers)}}</a>
                                ...
                                <ul class="list-inline">
                                    ...
                                    <li class="pull-right">
                                         @if($follow_question->is_favorite == \App\Models\Question::FAVORITE)
                                            <a href="javascript:;" wire:click="changeFavorite({{$follow_question->id}},'0')" class="text-yellow-600 hover:text-yellow-900">
                                                                                                               <i class="fa fa-star"></i></a>
                                        @else
                                            <a href="javascript:;" wire:click="changeFavorite({{$follow_question->id}},'1')" class="text-yellow-600 hover:text-yellow-900">
                                                <i class="fa fa-star-o"></i>
                                                            </a>
                                        @endif
                                        <a href="{{route('user.community.edit',$follow_question->id)}}" class="link-black text-sm"><i class="fa fa-edit"></i></a>
                                        <a href="#" class="link-black text-sm"><i class="fa fa-comments-o margin-r-5"></i>{{count($follow_question->answers)}}</a>
                                    </li>
                                </ul>
